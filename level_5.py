...
class Level_5(arcade.Window):
    ...
    def setup(self):
        ...
        self.grasshopper_sprite = arcade.Sprite("./Resources/Images/grasshopper_2.png", 0.2, angle = -368)
        self.grasshopper_sprite.center_x = 1894
        self.grasshopper_sprite.center_y = 164
        grasshopper_2_sprite = arcade.Sprite("./Resources/Images/grasshopper.png", 0.2, angle = 8)
        ...
        self.lizard_sprite = arcade.Sprite("./Resources/Images/lizard.png", 0.5)
        self.lizard_sprite.center_x = 2655
        self.lizard_sprite.center_y = 164
        lizard_2_sprite = arcade.Sprite("./Resources/Images/lizard_2.png", 0.5)
        ...
        self.frog_sprite = arcade.Sprite("./Resources/Images/frog.png", 1)
        self.frog_sprite.center_x = 4100
        self.frog_sprite.center_y = 174
        frog_2_sprite = arcade.Sprite("./Resources/Images/frog2.png", 1)
    ...
    def update(self, delta_time):
        ...
        if self.flag == True and self.grasshopper_list[0].center_x >= 1492 and self.grasshopper_list[0].center_x < 1894:
            ...
            self.grasshopper_sprite = arcade.Sprite("./Resources/Images/grasshopper_2.png", 0.2)
            self.grasshopper_sprite.center_x = 1894
            self.grasshopper_sprite.center_y = 164
