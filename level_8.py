...
class Level_8(arcade.Window):
    ...
    def setup(self):
        ...
        grass_hill_sprite.center_y = 154
        self.platforms_list.append(grass_hill_sprite)
        snow_hill = arcade.Sprite("./Resource/Images/snow_hill.png", 0.92)
        ...
        self.platforms_list.append(snow_hill)
        snow_hill = arcade.Sprite("./Resource/Images/snow_hill_2.png", 0.92)
        ...
        fox_sprite = arcade.Sprite("./Resource/Images/fox.png", 0.44)
        fox_sprite.center_x = 3760
        fox_sprite.center_y = 60                  #189
        fox_sprite_2 = arcade.Sprite("./Resource/Images/fox_2.png", 0.44)
        fox_sprite_2.center_x = 4700
        fox_sprite_2.center_y = 60                #189
