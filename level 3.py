...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.ant_sprite = arcade.Sprite("./Resource/Images/ant2.png", 0.25)
        self.ant_sprite.center_x = 3675
        self.ant_sprite.center_y = 155
        ant_2_sprite = arcade.Sprite("./Resource/Images/ant2_2.png", 0.25)
